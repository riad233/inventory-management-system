...
<div class="breadcrumb-nav">
    ...
    <a href="?url=superadmin/users">Users</a> / Edit User
</div>
  ...
  <div class="col-md-7 col-lg-5">
    <div class="form-page-card">
      <div class="form-page-card-header" style="background:#f5f3ff;">
        <i class="fas fa-user-edit" style="color:#6d28d9;"></i>
        <h5>Edit: <?php echo e($user['Username'] ?? ''); ?></h5>
      </div>
        ...
        <form method="POST" action="">
          ...
          <div class="mb-3">
            ...
            <input type="password" name="new_password" class="form-control form-control-sm
                   <?php echo isset($data['errors']['new_password']) ? 'is-invalid' : ''; ?>"
                   placeholder="Min 6 characters (optional)">
            <?php if (isset($data['errors']['new_password'])): ?>
            <div class="invalid-feedback"><?php echo e($data['errors']['new_password']); ?></div>
            <?php endif; ?>
          </div>
